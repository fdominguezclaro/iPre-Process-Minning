...
```{r plot}
exp_data2013 <- subset(data2013, SIGLA %in% exp_courses)
exp_data2013$SIGLA <- fct_infreq(exp_data2013$SIGLA)

exp_data2014 <- subset(data2014, SIGLA %in% exp_courses)
exp_data2014$SIGLA <- fct_infreq(exp_data2014$SIGLA)

exp_data2015 <- subset(data2015, SIGLA %in% exp_courses)
exp_data2015$SIGLA <- fct_infreq(exp_data2015$SIGLA)

exp_data2016 <- subset(data2016, SIGLA %in% exp_courses)
